...
terraform plan -out out.terraform -var 'PATH_TO_PUBLIC_KEY=/Users/HeMan/.aws/awsterraformkey.pub'
...
while true; do
    ...
    case $yn in
        [Yy]* ) terraform apply out.terraform -var 'PATH_TO_PUBLIC_KEY=/Users/HeMan/.aws/awsterraformkey.pub'; break;;
        [Nn]* ) exit;;
